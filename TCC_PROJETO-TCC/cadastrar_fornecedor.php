        ...
        <form class="w3-container" action="salvar_fornecedor.php" method="post" onsubmit="return validarFormulario()">
            ...
            <div class="form-group">
                ...
                <input class="w3-input w3-border" type="text" name="telefone" id="telefone" 
                       value="<?php echo isset($dados_form['telefone']) ? htmlspecialchars($dados_form['telefone']) : ''; ?>" 
    ...
    <script>
        function validarFormulario() {
            ...
            if (telefone && telefone.length < 10) {
                document.getElementById('telefone-error').textContent = 'Telefone deve ter entre 10 e 11 dígitos';
                isValid = false;
            }
